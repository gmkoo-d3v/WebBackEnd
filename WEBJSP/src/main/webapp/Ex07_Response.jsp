...
<%
	/*  
        ...
        response  객체 
        1. 표현식 (출력)  <%=
        2. 페이지 이동 (response.sendRedirect()) : 서버에게 새로운 페이지 요청 ...    F5 누른것과 같다는 뜻
        2.1 javascript 표현 :  location.href="이동할 주소"                            F5 누른것과 같은 효과
...
<body>
		...
		2. sendRedirect 
		<%
		//	response.sendRedirect("Ex01_index.jsp"); //	나 이 페이지 Ex01_index.jsp 보여줘 (response.sendRedirect) = location.href 자바서 쓸꺼냐 html에서 쓸꺼냐
		%>
</body>
