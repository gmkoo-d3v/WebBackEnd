...
<!--  
	...
	1. Cookie (메모리 쿠키 - 파일 쿠키 (local 디스크에 txt 암호화 시켜서 저장 : 소멸타임 기간정해주면 로컬스토리지로가고 안정해주면 메모리로간다)
	...
	3. server 영속적 : 파일.txt  (관리가 힘들어요 규칙이 있어야되서 )
	4. DB server    : 보안, 영속적인 데이터 관리 >> 비용 >> 클라우드 db나 로컬db 
-->      
<!DOCTYPE html>
<html>
<head>
