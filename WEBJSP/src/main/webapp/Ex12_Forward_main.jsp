...
<% 
	...
	*/
	...
	// include는 자기가 써먹는거
	// forward는 논리의 흐름제어에 써먹는거지 자기껄 보여줄려는게 아니다. 
	// 요청된 주소를 안바꾸고 요청 내용만 바꾸는 방식
	//*****************************
	// 요청의 흐름제어 = forward
	//*****************************
	// http://localhost:8081/WEBJSP/Ex12_Forward_main.jsp?code=B
	//http://localhost:8081/WEBJSP/Ex12_Forward_main.jsp?code=A
	//http://localhost:8081/WEBJSP/Ex12_Forward_main.jsp?code=C 같은거 테스트
...
<body>
		...
		fdsklfdsfsd 이런거 의미없다 요청된(forward) jps 내용이 들어가버림
			fdsklfdsfsd
	sdxccfvsadfds
	dsf
	sdafdsa
