...
/*  
		...
		>>실경로 : D:\MSA-JAVA\WEB\WebBackEnd\WEBJSP\src\main\webapp 안에 자원을 서비스 하겠다 실제로는 이건 소스고
		배포되는 파일의 주소는 
		>> 배포경로 (이클립스 Tomcat 내장 >>>>)
		~\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WEBJSP
		D:\MSA-JAVA\WEB\WebBackEnd\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WEBJSP
		
		맥에서 디플로이 폴더만든거 처럼 퍼블리시 주소
...
<body>
	...
	<%
		String param = application.getInitParameter("email"); //web-inf/web.xml에서 선언한 emil filepath
