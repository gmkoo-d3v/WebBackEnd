...
/*  
		...
		>>실경로 : D:\MSA_EDU\WEB\WebBackEnd\BackEndLabs\WEBJSP\src\main\webapp 안에 자원을 서비스 하겠다
		>>배포경로(이클립스 Tomcat 내장 >>> )
		>>D:\MSA_EDU\WEB\WebBackEnd\BackEndLabs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WEBJSP
