<%@ page language="java" contentType="text/html; charset=UTF-8"
            ...
            <div class="row gy-5">
              <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                ...
                <div class="d-flex">
                  ...
                  <a href="https://www.youtube.com/watch?v=YwxAiEAUFKo" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
                </div>
              </div>
    ...
    <section id="kanban-frame" class="section" style="display: none;">
      <div class="container">
        ...
        <iframe id="kanbanIframe" src="kanban.html" width="100%" height="800" style="border: none; border-radius: 12px; box-shadow: 0 0 10px rgba(114, 12, 12, 0.1);"></iframe>
      </div>
    </section>
    ...
    <section id="map-frame" class="section" style="display: none;">
      <div class="container">
        <iframe id="mapIframe" src="map.html" width="100%" height="600" style="border: none; border-radius: 12px; box-shadow: 0 0 10px rgba(0,0,0,0.1); visibility: hidden;" onload="this.style.visibility='visible'"></iframe>
      </div>
    </section>
            ...
            <div class="row gy-4">
              ...
              <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                <div class="team-card">
                  ...
                  <p class="desc">웹 UI/UX에 관심 많고 사용자가 편한 서비스를 만들고 싶어요.</p>
                </div>
              </div>
    
              <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                <div class="team-card">
                  <h3 style="color: #0dcaf0;">이재성</h3>
                  <div class="icon"><i class="bi bi-person-circle"></i></div>
                  <p class="role">Back-end Developer</p>
                  <p class="desc">서버와 데이터 흐름을 책임지고 있습니다.</p>
                </div>
              </div>
    
              <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
                <div class="team-card">
                  <h3 style="color: #fd7e14;">이재원</h3>
                  <div class="icon"><i class="bi bi-person-circle"></i></div>
              ...
              <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="400">
                <div class="team-card">
                  <h3 style="color: #0d6efd;">황유석</h3>
                  <div class="icon"><i class="bi bi-person-circle"></i></div>
                  <p class="role">AI Researcher</p>
                  <p class="desc">데이터를 분석하고 AI 모델을 실험하고 있어요.</p>
                </div>
              </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1">
      ...
      <script>
        ...
        function toggleMap() {
          ...
          if (!isVisible) map.scrollIntoView({ behavior: "smooth" });
        }
      </script>
      ...
      <script>
        document.addEventListener("DOMContentLoaded", function () {
          ...
          if (userInfo && userInfo.name) {
            ...
            <button class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#deleteModal">회원탈퇴</button>
    `;
    
          } else {
            // 로그인하지 않은 경우
            userInfoDiv.innerHTML = `
              <a href="login.html" class="btn btn-sm btn-outline-primary">로그인</a>
            `;
          }
        });
      ...
      <!-- 🔽 이 스크립트를 추가 -->
    <script type="text/javascript" src="https://dapi.kakao.com/v2/maps/sdk.js?appkey=faedc692ee4f1fb94b995cdb777abeb9"></script>
    <script>
